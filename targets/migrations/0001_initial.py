    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('targetClass', models.CharField(choices=[('VS', 'Variable Star'), ('EX', 'Exoplanet'), ('DS', 'Deep Sky Object'), ('PL', 'Planet'), ('LU', 'Luna'), ('SU', 'Sun'), ('SA', 'Satellite'), ('OT', 'Other')], default='DS', max_length=255)),
