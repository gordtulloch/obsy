...
from . import views
from .views import target_all_list,target_query,target_detail_view, schedule, scheduleDetails,targetUpload,targetUploadSuccess
...
urlpatterns = [
    ...
    path('import/', targetUpload, name='upload'),
